                ...
                <div className="container-fluid">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
                        ...
                        <div className="space-y-4">
                            <h4 className="text-[10px] font-bold text-[var(--color-text-main)] uppercase tracking-[0.3em] opacity-50">Navigation</h4>
                            <div className="flex flex-col gap-3 text-[var(--color-text-muted)] text-[14px] font-medium">
                                ...
                                <a href="/developer" className="hover:text-[var(--color-primary)] transition-colors">Developer</a>
                                <a href="/community" className="hover:text-[var(--color-primary)] transition-colors">Community</a>
                            </div>
                        </div>

                        <div className="space-y-4">
                            <h4 className="text-[10px] font-bold text-[var(--color-text-main)] uppercase tracking-[0.3em] opacity-50">Connect</h4>
                            <div className="flex flex-col gap-3 text-[var(--color-text-muted)] text-[14px] font-medium">
                        ...
                        <div className="space-y-4">
                            <h4 className="text-[10px] font-bold text-[var(--color-text-main)] uppercase tracking-[0.3em] opacity-50">Status</h4>
