...
import { Github, Twitter, Send, ShieldCheck, Linkedin } from "lucide-react";
...
const Contact = () => {
  ...
  const socials = [
    {
      icon: Github,
      link: "https://github.com/mohit-solidity",
      label: "GitHub",
    },
    ...
    {
      icon: Linkedin,
      link: "https://www.linkedin.com/in/mohit-05914422a/",
      label: "Linkedln",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 py-20 min-h-[90vh] flex flex-col justify-center">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div>
            ...
            >
              Let's build the <br />{" "}
              <span className="text-cyan-400">decentralized future.</span>
            </motion.h1>

            <p className="text-xl text-gray-400 mb-12 max-w-md leading-relaxed">
              Open for senior engineering roles, ecosystem strategy
              consultancies, and collaborative Web3 ventures.{" "}
            </p>
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
              <div className="space-y-2">
                <label className="text-xs font-bold text-gray-500 uppercase tracking-widest ml-4">
                  Email Address
                </label>
                <input
                  type="email"
              ...
              >
                ...
                {formState === "sent" && (
                  <>
                    <ShieldCheck size={20} className="text-cyan-400" /> Securely
                    Transmitted
                  </>
                )}
              </button>
